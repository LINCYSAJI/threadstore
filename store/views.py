...
class AddToCartView(View):
    ...
    def post(self,request,*args, **kwargs):
        ...
        basket_obj=request.user.cart #using related name in models
...
class CartSummaryView(View):
    ...
    def get(self,request,*args, **kwargs):
        ...
        qs=request.user.cart.cartitems.filter(is_order_placed=False).order_by("created_date") #using related names
...
class CartQuantityUpdateView(View):
    ...
    def post(self,request,*args, **kwargs):
        ...
        basket_item_obj.save() #to save changes
